...
export default function FraseFinal() {
  return (
    <section className="relative flex flex-col items-center justify-center overflow-hidden bg-black py-20 px-4 text-center">
      <StarField count={40} />
      <AnimateOnScroll variant="fade-up">
        <p className="relative z-10 flex flex-col items-center text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
